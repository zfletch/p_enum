defmodule PLEnumTest do
  ...
  describe "pchunk_by/2" do
    ...
    test "runs in parallel" do
      assert_time_within(200, fn ->
        PLEnum.pchunk_by([1, 2, 3], fn (_) -> :timer.sleep(100) end)
      end)
  ...
  describe "pcount/2" do
    ...
    test "runs in parallel" do
      assert_time_within(200, fn ->
        PLEnum.pcount([1, 2, 3], fn (_) -> :timer.sleep(100) end)
      end)
      refute_time_within(200, fn ->
  ...
  describe "pdedup_by/2" do
    ...
    test "runs in parallel" do
      assert_time_within(200, fn ->
        PLEnum.pdedup_by([1, 2, 3], fn (_) -> :timer.sleep(100) end)
      end)
      refute_time_within(200, fn ->
  ...
  describe "peach/2" do
    ...
    test "runs in parallel" do
      assert_time_within(200, fn ->
        PLEnum.peach([1, 2, 3], fn (_) -> :timer.sleep(100) end)
      end)
      refute_time_within(200, fn ->
  ...
  describe "pflat_map/2" do
    ...
    test "runs in parallel" do
      assert_time_within(200, fn ->
        PLEnum.pflat_map([1, 2, 3], fn (_) -> [:timer.sleep(100)] end)
      end)
      refute_time_within(200, fn ->
  ...
  describe "pfilter/2" do
    ...
    test "runs in parallel" do
      assert_time_within(200, fn ->
        PLEnum.pfilter([1, 2, 3], fn (_) -> :timer.sleep(100) end)
      end)
      refute_time_within(200, fn ->
  ...
  describe "pgroup_by/3" do
    ...
    test "runs in parallel" do
      assert_time_within(200, fn ->
        PLEnum.pgroup_by([1, 2, 3], fn (_) -> :timer.sleep(100) end)
      end)
      refute_time_within(200, fn ->
        Enum.group_by([1, 2, 3], fn (_) -> :timer.sleep(100) end)
      end)
      refute_time_within(200, fn ->
        PLEnum.pgroup_by([1, 2, 3], & &1, fn (_) -> :timer.sleep(100) end)
      end)
    end
  end
  ...
  describe "group_byp/3" do
    ...
    test "runs in parallel" do
      assert_time_within(200, fn ->
        PLEnum.group_byp([1, 2, 3], & &1, fn (_) -> :timer.sleep(100) end)
      end)
      refute_time_within(200, fn ->
  ...
  describe "pgroup_byp/3" do
    ...
    test "runs in parallel" do
      assert_time_within(250, fn ->
        PLEnum.pgroup_byp([1, 2, 3], fn (_) -> :timer.sleep(100) end, fn (_) -> :timer.sleep(100) end)
      end)
      refute_time_within(200, fn ->
  ...
  describe "pinto/3" do
    ...
    test "runs in parallel" do
      assert_time_within(200, fn ->
        PLEnum.pinto([1, 2, 3], [], fn (_) -> :timer.sleep(100) end)
      end)
      refute_time_within(200, fn ->
  ...
  describe "pmap/2" do
    ...
    test "runs in parallel" do
      assert_time_within(200, fn ->
        PLEnum.pmap([1, 2, 3], fn (_) -> :timer.sleep(100) end)
      end)
      refute_time_within(200, fn ->
  ...
  describe "pmap_every/3" do
    ...
    test "runs in parallel" do
      assert_time_within(200, fn ->
        PLEnum.pmap_every([1, 2, 3], 1, fn (_) -> :timer.sleep(100) end)
      end)
      refute_time_within(200, fn ->
  ...
  describe "pmap_join/3" do
    ...
    test "runs in parallel" do
      assert_time_within(200, fn ->
        PLEnum.pmap_join([1, 2, 3], fn (_) -> :timer.sleep(100) end)
      end)
      refute_time_within(200, fn ->
  ...
  describe "pmax_by/2" do
    ...
    test "runs in parallel" do
      assert_time_within(200, fn ->
        PLEnum.pmax_by([1, 2, 3], fn (_) -> :timer.sleep(100) end)
      end)
      refute_time_within(200, fn ->
  ...
  describe "pmax_by/3" do
    ...
    test "runs in parallel" do
      assert_time_within(200, fn ->
        PLEnum.pmax_by([1, 2, 3], fn (_) -> :timer.sleep(100) end, fn -> 1 end)
      end)
      refute_time_within(200, fn ->
  ...
  describe "pmin_by/2" do
    ...
    test "runs in parallel" do
      assert_time_within(200, fn ->
        PLEnum.pmin_by([1, 2, 3], fn (_) -> :timer.sleep(100) end)
      end)
      refute_time_within(200, fn ->
  ...
  describe "pmin_by/3" do
    ...
    test "runs in parallel" do
      assert_time_within(200, fn ->
        PLEnum.pmin_by([1, 2, 3], fn (_) -> :timer.sleep(100) end, fn -> 1 end)
      end)
      refute_time_within(200, fn ->
  ...
  describe "pmin_max_by/2" do
    ...
    test "runs in parallel" do
      assert_time_within(200, fn ->
        PLEnum.pmin_max_by([1, 2, 3], fn (_) -> :timer.sleep(100) end)
      end)
      refute_time_within(200, fn ->
  ...
  describe "pmin_max_by/3" do
    ...
    test "runs in parallel" do
      assert_time_within(200, fn ->
        PLEnum.pmin_max_by([1, 2, 3], fn (_) -> :timer.sleep(100) end, fn -> 1 end)
      end)
      refute_time_within(200, fn ->
  ...
  describe "preject/2" do
    ...
    test "runs in parallel" do
      assert_time_within(200, fn ->
        PLEnum.preject([1, 2, 3], fn (_) -> :timer.sleep(100) end)
      end)
      refute_time_within(200, fn ->
  ...
  describe "puniq_by/2" do
    ...
    test "runs in parallel" do
      assert_time_within(200, fn ->
        PLEnum.puniq_by([1, 2, 3], fn (_) -> :timer.sleep(100) end)
      end)
      refute_time_within(200, fn ->
